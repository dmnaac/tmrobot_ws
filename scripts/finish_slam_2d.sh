...
map_root="${HOME}/Workspace/cartographer_ws/map"
map_name="$current_date_time"

# lua_root="${HOME}/Workspace/cartographer_ws/cartographer_ros_ws/src/cartographer_ros/cartographer_ros/configuration_files"
# lua_name="cartographer_ros_sim.lua"
